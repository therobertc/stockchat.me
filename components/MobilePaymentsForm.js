...
const Field = ({
  ...
  <div className="MFormRow">
    <label htmlFor={id} className="MFormRowLabel">
      {label}
    </label>
    <input
      className="MFormRowInput"
      id={id}
      type={type}
...
const SubmitButton = ({ processing, error, children, disabled }) => (
  <button
    className={`MSubmitButton ${error ? "MSubmitButton--error" : ""}`}
    type="submit"
...
const ErrorMessage = ({ children }) => (
  <div className="MErrorMessage" role="alert">
...
const ResetButton = ({ onClick }) => (
  <button type="button" className="MResetButton" onClick={onClick}>
...
const CheckoutForm = () => {
  ...
  return paymentMethod ? (
    <div className="MResult">
      <div className="MResultTitle" role="alert">
        Payment successful
      </div>
