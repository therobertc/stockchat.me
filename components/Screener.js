...
class Feed extends Component {
  ...
  async getTrandingData() {
    return fetch(
      "https://sharestock.io/api/black_ink_api/?type=type1&token=34a19b3ebe75a5431dd6eb8b9d18f9e75be67e46",
      {
        method: "GET",
      }
    )
            ...
            >
              ...
              <p
                style={{
                  ...
                  textAlign: "right",
                  color:
                    parseFloat(service.percentChange) < 0
                      ? "#ff3636"
                      : "#33CC00",
                }}
              >
                {(service.percentChange * 100).toFixed(2)}%
              </p>
            </div>
          </div>
        </div>
